...
@AllArgsConstructor
@NoArgsConstructor
@Schema(description = "Item Update 요청")
public class ItemUpdateRequest {
    ...
    @Size(max = 50, message = "제조사는 50자 이내로 입력해주세요.")
    ...
    @Schema(description = "purchase_unit_price(매입단가)", example = "1020.50")
    private Double purchaseUnitPrice;

    @Schema(description = "sales_unit_price(매출단가)", example = "1020.50")
