package kr.co.primes_cloud.erp.payload.request.itemprogress;
...
@AllArgsConstructor
@NoArgsConstructor
@Schema(description = "ItemProgress Create 요청")
public class ItemProgressCreateRequest {
    ...
    @NotBlank(message = "공정 이름은 필수 입력 항목입니다.")
