package kr.co.primes_cloud.erp.payload.request.item;
...
public class ItemSearchRequest {
    ...
    @Schema(description = "제조사", example = "샘플값")
    private String manufacturerName;

    @Schema(description = "제품대분류 (codeValue)", example = "PRD-001-002")
    private String itemType1;

    @Schema(description = "제품중분류 (codeValue)", example = "PRD-001-002")
    private String itemType2;

    @Schema(description = "제품소분류 (codeValue)", example = "PRD-001-002")
    private String itemType3;

    @Schema(description = "단위", example = "샘플값")
    private String itemUnit;

    @Schema(description = "Lot 사이즈 (codeValue)", example = "PRD-001-002")
    ...
    @Schema(description = "purchase_unit_price(매입단가)")
    private Double purchaseUnitPrice;

    @Schema(description = "sales_unit_price(매출단가)")
