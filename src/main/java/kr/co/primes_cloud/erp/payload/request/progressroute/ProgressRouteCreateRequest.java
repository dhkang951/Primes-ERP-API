package kr.co.primes_cloud.erp.payload.request.progressroute;
...
@AllArgsConstructor
@NoArgsConstructor
@Schema(description = "ProgressRoute Create 요청")
public class ProgressRouteCreateRequest {
    ...
    @Schema(description = "default cycle time", example = "1000.00")
    private Double defaultCycleTime;

    @Schema(description = "lot size", example = "1000.00")
    ...
    @Schema(description = "optimal_progress_inventory_level", example = "100.50")
    private Double optimalProgressInventoryQty;

    @Schema(description = "safety_progress_inventory_level", example = "100.50")
