package kr.co.primes_cloud.erp.payload.request.mbom;
...
@AllArgsConstructor
@NoArgsConstructor
@Schema(description = "Mbom Create 요청")
public class MbomCreateRequest {
    ...
    @Schema(description = "부품 투입량", example = "100.50")
