package kr.co.primes_cloud.erp.controller;
...
public class ItemController {
    ...
    @Operation(summary = "Item 품명품번규격 중복 체크")
    @GetMapping("/check-duplicate")
    public CommonResponse<Boolean> checkDuplicate(@Valid ItemSearchRequest searchRequest) {
        return CommonResponse.createSuccess(itemService.checkDuplicate(searchRequest));
    }
